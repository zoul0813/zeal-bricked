...
CFLAGS=-mz80 --opt-code-speed -c --codeseg TEXT -I$(ZOS_INCLUDE) -I$(ZVB_INCLUDE) -I$(ZGDK_INCLUDE)
ifdef EMULATOR
CFLAGS+=-DEMULATOR
endif
ifdef DEBUG
...
LDFLAGS=-n -mjwx -i -b _HEADER=0x4000 -k $(ZOS_LIB_PATH) -l z80 -k $(ZVB_LIB_PATH) -k $(ZGDK_LIB_PATH) -l zvb_gfx -l zvb_sound -l zgdk
